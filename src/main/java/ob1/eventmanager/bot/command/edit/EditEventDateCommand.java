...
@LocalCommand("edit_event_date")
public class EditEventDateCommand implements LocalCommandHandler {
    ...
    public void handle(MessageStateMachine<LocalChatStates> stateMachine, Map<String, Object> headers) {
        ...
        stateMachine.setCurrentState(LocalChatStates.EDIT_EVENT_DATE);
